...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            pandas.DataFrame(
                dict(c=[3], a=pandas.Categorical([1]), b=pandas.Categorical([2]))
            ),
        ),
